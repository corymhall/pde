...
export interface RushConfigOptions {
  /**
  ...
  /**
    ...
    * @default ">=12.13.0 <13.0.0 || >=14.15.0 <15.0.0 || >=16.13.0 <17.0.0"
    */
  ...
  eventHooks?: {
    /**
      ...
      * @default common/scripts/pre-rush-install.js
      */
...
export class RushConfig extends JsonFile {
  constructor(project: Project, options: RushConfigOptions) {
    super(project, 'rush.json', {
      allowComments: true,
      committed: true,
      obj: {
